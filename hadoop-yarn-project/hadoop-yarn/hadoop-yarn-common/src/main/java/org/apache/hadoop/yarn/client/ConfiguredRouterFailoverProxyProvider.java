...
/**
 *copy from {@link ConfiguredRMFailoverProxyProvider}
 * @param <T>
 */
@InterfaceAudience.Private
@InterfaceStability.Unstable
public class ConfiguredRouterFailoverProxyProvider<T>
    implements RMFailoverProxyProvider<T> {
  private static final Log LOG =
      LogFactory.getLog(ConfiguredRouterFailoverProxyProvider.class);
