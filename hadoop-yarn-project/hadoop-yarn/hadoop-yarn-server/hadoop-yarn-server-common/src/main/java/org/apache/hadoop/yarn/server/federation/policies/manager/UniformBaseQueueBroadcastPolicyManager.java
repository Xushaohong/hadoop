...
import org.apache.hadoop.yarn.server.federation.policies.router.UniformRandomBaseQueueRouterPolicy;

/**
 * This class represents a simple implementation of a {@code
 * FederationPolicyManager}.
 *
 * It combines the basic policies: {@link UniformRandomBaseQueueRouterPolicy} and
 ...
 * broadcasted.
 */
public class UniformBaseQueueBroadcastPolicyManager extends AbstractPolicyManager {

  public UniformBaseQueueBroadcastPolicyManager() {
    // this structurally hard-codes two compatible policies for Router and
    // AMRMProxy.
    routerFederationPolicy = UniformRandomBaseQueueRouterPolicy.class;
