 ...
 * subclusters that filter by queue. This policy is easy to use and good for testing.
 *
 ...
 * of the "weights", in which case the {@link UniformRandomBaseQueueRouterPolicy} send
 * load to them, while {@code WeightedRandomRouterPolicy} does not.
 */
public class UniformRandomBaseQueueRouterPolicy extends AbstractRouterPolicy {

  private Random rand;

  public UniformRandomBaseQueueRouterPolicy() {
  ...
  public SubClusterId getHomeSubcluster(
    ...
    Map<SubClusterId, SubClusterInfo> activeSubclusters =
        getActiveSubclustersByQueue(appSubmissionContext.getQueue());
