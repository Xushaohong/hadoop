...
public class ClientNamenodeProtocolServerSideTranslatorPB implements
  ...
  private static final RefreshProtectionResponseProto
    VOID_REFRESH_PROTECTION_RESPONSE = RefreshProtectionResponseProto
      .getDefaultInstance();
  ...
  @Override
  public RefreshProtectionResponseProto refreshProtection(RpcController
      controller, RefreshProtectionRequestProto req) throws ServiceException {
    try {
      server.refreshProtection();
      return VOID_REFRESH_PROTECTION_RESPONSE;
    } catch (IOException e) {
      throw new ServiceException(e);
    }
  }
  ...
  @Override
  public GetProtectionResponseProto getProtection(RpcController controller,
      GetProtectionRequestProto req) throws ServiceException {
    try {
      String value = server.getProtection();
      return GetProtectionResponseProto.newBuilder().setValue(value).build();
    } catch (IOException e) {
      throw new ServiceException(e);
    }
  }
