...
public interface HdfsClientConfigKeys {
  ...
  boolean DFS_WEBHDFS_ENABLED_DEFAULT = false;
  ...
  String  DFS_CLIENT_WRITABLE_NAMENODE_LIST_KEY = "dfs.writable.namenode.list";
  ...
  String DFS_CLIENT_FORBIDDEN_CLUSTERS = "dfs.client.forbidden.clusters";
