...
public class ClientNamenodeProtocolTranslatorPB implements
  ...
  private final static RefreshProtectionRequestProto
      VOID_REFRESH_PROTECTION_REQUEST =
      RefreshProtectionRequestProto.newBuilder().build();

  final static GetProtectionRequestProto
      VOID_GET_PROTECTION_REQUEST =
      GetProtectionRequestProto.newBuilder().build();
  ...
  public void refreshProtection() throws IOException {
    try {
      rpcProxy.refreshProtection(null, VOID_REFRESH_PROTECTION_REQUEST);
    } catch (ServiceException e) {
      throw ProtobufHelper.getRemoteException(e);
    }
  }
  ...
  public String getProtection() throws IOException {
    try {
      return rpcProxy.getProtection(null, VOID_GET_PROTECTION_REQUEST)
          .getValue();
    } catch (ServiceException e) {
      throw ProtobufHelper.getRemoteException(e);
    }
