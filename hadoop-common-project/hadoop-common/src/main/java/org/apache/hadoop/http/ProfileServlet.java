...
public class ProfileServlet extends HttpServlet {
  ...
  private static final String HADOOP_HOME_PROPERTY = "hadoop.home";
  ...
  static String getAsyncProfilerHome() {
    ...
    if (StringUtils.isEmpty(asyncProfilerHome)) {
      String hadoopHomePath = getHadoopHome();
      if (StringUtils.isNotEmpty(hadoopHomePath)) {
        asyncProfilerHome = getHadoopHome() + "/async-profiler";
      }
    }
  ...
  static String getHadoopHome() {
    String hadoopHome = System.getenv(HADOOP_HOME_ENV);
    // if ENV is not set, see if -Dasync.profiler.home=/path/to/async/profiler/home is set
    if (hadoopHome == null || hadoopHome.trim().isEmpty()) {
      hadoopHome = System.getProperty(HADOOP_HOME_PROPERTY);
    }
