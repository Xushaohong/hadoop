...
public class TestSaslTAuthRPC extends TestRpcBase {
  ...
  private void logout(FileSystem fileSystem, String keyPath) throws Exception{
    UserGroupInformation.getCurrentUser().logoutUserFromTAuth();
    UserGroupInformation.setLoginUser(null);
    fileSystem.delete(new Path(keyPath), true);
  }
  ...
  public void testTauthLogin() throws Exception {
    ...
    logout(localFilesystem, keyPath);
    ...
    Assert.assertEquals("hdfsService", ugi.getShortUserName());
    logout(localFilesystem, keyPath);
